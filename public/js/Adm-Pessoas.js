...
function mostrarCampos() {
    ...
    if ($("#situacao_membro").val() === 'Membro') {
        ...
        if ($("#codigoTc").val() != '') {
            ...
            r = document.getElementById("regional");
            itemSelecionado = r.options[r.selectedIndex].value;
            ...
            $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                                ...
                                console.log('oi' + congregacao.congregacao)
              ...
              $("#congregacao").val(data.congregacao_id);
           	...
           	$("#form_codigoTc").hide();
            $("#situacao_membro").val('Não Membro');
            $("#form_regional").hide();
           	$("#form_codigoTc").hide();
            $("#form_congregacao").hide();
            $("#form_relacao").hide();
...
function montarLista(p) {
 var linha = " <tr> <th scope='row'>"+p.id+"</th> <td>"+p.nome+"</td> <td>"+p.celular+"<td>"+p.telefone+"</td> <td>"+ '<button type="button"' + 'class="btn btn-sm btn-success mr-1"' + 'onclick="editarPessoa(' + p.id + ')"> Editar </button>' + '<button type="button"' + 'class="btn btn-sm btn-primary mr-1"' + 'onclick="viewPessoa(' + p.id + ')"> Visualizar </button>' + "</td></tr> ";
...
function validaRegional(qErrors) {
    ...
    console.log('chamou valida regional');

    if ($('#situacao_membro').val() == 'Membro') {

        if ($('#regional').val() == null) {

            console.log($('#regional').val() + 'e Invalido');
            ...
            console.log($('#regional').val() + 'e Valido');
