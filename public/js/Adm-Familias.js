...
function montarListaFamilia(p) {
    ...
    linha = '<tr>' +
        ...
        '<button type="button"' + 'class="btn btn-sm btn-primary mr-1"' + 'onclick="editarFamilia(' + p.id + ')"> Editar </button>' +
      
      
        '<button type="button"' + 'class="btn btn-sm btn-success "' + 'onclick="viewFamilia(' + p.id + ')"> Visualizar </button>' +
