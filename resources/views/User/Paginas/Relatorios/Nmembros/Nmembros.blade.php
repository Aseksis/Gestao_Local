...
<script type="text/javascript" src="<?php echo asset('js/User-Relatorios-Nmembros.js')?>"></script>
...
<div id="wrapper">
  ...
  <strong>Relatório - Não Membros!</strong>
...
<form>
  <div class="form-row">
    ...
    <div style="margin-left:0px;padding-left:0px;" class="form-group col-2">
                                        ...
                                        <button  onClick="filtrarMembros()"  type="button"  style="height: calc(2.19rem + 2px);" class="btn-sm btn-secondary mr-1">Filtrar</button>
                                        <a class="btn btn-success"  style="height: calc(2.19rem + 2px);"  onClick="criarExel()">Gerar Excel</a>
  ...
  <table class="table" style=" text-align: center; zoom:88%;"   id="tabelaNmembros">
