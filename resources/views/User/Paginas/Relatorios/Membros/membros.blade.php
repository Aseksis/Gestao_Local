...
<script type="text/javascript" src="<?php echo asset('js/User-Relatorios-Membros.js')?>"></script>
...
<div id="wrapper">
  ...
  <strong>Relatório - Membros!</strong>
...
<form>
  ...
  <table class="table" style=" text-align: center; zoom:88%;"   id="tabelaMembros">
