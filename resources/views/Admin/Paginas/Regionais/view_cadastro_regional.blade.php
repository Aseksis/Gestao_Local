<div class="modal" tabindex="-1" role="dialog" id="dlgCadastro" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form class="form-horizontal" id="formCadastroRegional">
                ...
                <div class="modal-body">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#regional" role="tab" aria-controls="dados_pessoais">Regional</a>
                        </li>
                    </ul>
                                ...
                                <div class="card-body">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="regional_nome" onBlur="validaRegionalNome()" autocomplete="off">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="nome">Pastor Regional:</label>
                                            <input type="text" class="form-control" id="pastor_regional" onBlur="validaPastorRegional()" autocomplete="off">
                                            <div class="invalid-feedback">
