            ...
            <form class="form-horizontal" id="formCadastroRegional">
                ...
                <div class="modal-body">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#regional" role="tab" aria-controls="dados_pessoais">Administrador</a>
                        </li>
                    </ul>
                                ...
                                <div class="card-body">
                                    <form>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6" style="margin-bottom:2%;">
                                                <input type="password" id="senha" class="form-control" autocomplete="off" placeholder="Nome:" required>
                                            </div>
